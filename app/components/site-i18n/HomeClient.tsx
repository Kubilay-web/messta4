...
// app/components/site-i18n/HomeClient.tsx
// Ana sayfanın istemci arayüzü — dil context'i ile çevrilir.
// Veri (ürün/oturum) sunucu tarafından prop olarak gelir.

import Link from "next/link";
import { useSiteLang } from "./SiteLang";
import { SiteLangSwitcher } from "./SiteLang";
import { SiteLang } from "./site-dictionary";
...
export default function HomeClient({
  ...
  const features = [
    { icon: "🚚", title: t("feat1Title"), text: t("feat1Text") },
    { icon: "🔒", title: t("feat2Title"), text: t("feat2Text") },
    { icon: "↩️", title: t("feat3Title"), text: t("feat3Text") },
    { icon: "🛡️", title: t("feat4Title"), text: t("feat4Text") },
  ];
    ...
    >
        ...
        <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-10 px-4 py-12 lg:flex-row lg:py-20">
          <div className="flex w-full flex-col items-start gap-5 lg:w-1/2">
            ...
            <h1 className="text-3xl font-extrabold leading-tight sm:text-4xl lg:text-5xl">
              {product ? product.name : t("heroTitleFallbackA")}{" "}
              <span className="text-indigo-600">
                {product ? t("heroTitleSuffix") : t("heroTitleFallbackB")}
              </span>
            </h1>
            <p className="max-w-xl text-base text-gray-500 sm:text-lg">
              {product?.description || t("heroDescFallback")}
            </p>
      ...
      <section className="mx-auto w-full max-w-7xl px-4 pb-14">
        <div className="flex flex-col items-center gap-4 rounded-3xl bg-gradient-to-r from-indigo-600 to-violet-600 px-6 py-10 text-center text-white sm:py-14">
          ...
          <p className="max-w-xl text-indigo-100">{t("ctaDesc")}</p>
          <Link
            href={shopHref}
